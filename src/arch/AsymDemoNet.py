...
class MixerBlock(nn.Module):
    def __init__(self, c, expand=2, kernel_size=1, padding=0, groups=1):
        ...
        self.conv2 = nn.Conv2d(in_channels=expand // 2, out_channels=c, kernel_size=kernel_size, padding=padding, stride=1, groups=groups, bias=True)
...
class NAFBlock(nn.Module):
    def __init__(self, c, expand=2):
        super().__init__()
        self.hblock = MixerBlock(c, kernel_size=(1, 3), padding=(0, 1), expand=expand, groups=4)
        self.vblock = MixerBlock(c, kernel_size=(3, 1), padding=(1, 0), expand=expand, groups=4)
